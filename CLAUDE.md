...
Architecture is frozen and fully implemented. All modules pass tests. Next step is train.py (Step 7 in the development plan).
...
- `edge_mask/train.py` — Training loop (AdamW, cosine schedule, mixed precision)
- `edge_mask/evaluate.py` — BF1, ODS, Dice metrics
- Dataset / dataloader
- `edge_mask/config.yaml`
