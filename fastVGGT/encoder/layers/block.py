...
class Block(nn.Module):
    ...
    def forward(self, x: Tensor, pos=None, merge_info=None) -> Tensor:
        def attn_residual_func(x: Tensor, pos=None, merge_info=None) -> Tensor:
            return self.ls1(self.attn(self.norm1(x), pos=pos, merge_info=merge_info))
        ...
        if self.training and self.sample_drop_ratio > 0.1:
            ...
            x = x + attn_residual_func(x, pos=pos, merge_info=merge_info)
