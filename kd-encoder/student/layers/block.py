...
# Simplified for Phase 0A benchmarking (removed NestedTensorBlock)
...
class Block(nn.Module):
    ...
    def forward(self, x: Tensor, pos=None) -> Tensor:
        ...
        if self.training and self.sample_drop_ratio > 0.1:
            # For Phase 0A benchmarking (eval mode), this path won't be taken
            ...
            # Phase 0A benchmarking uses this path (eval mode)
...
def drop_add_residual_stochastic_depth(
    ...
    """Drop paths (Stochastic Depth) with residual addition."""
    b, n, d = x.shape
